...
barAddress = list(dataBars["ADDRESS"])
...
for nr, ltB, lnB, nameB, addr in zip(barNumber, latB, lonB, barName, barAddress):
    iframeBar = folium.IFrame(html = htmlBar % (nameB, nameB, nr, addr), width = 250, height = 100)
